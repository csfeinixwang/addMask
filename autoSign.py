...
ul4=driver.find_element_by_xpath("/html[@class='pixel-ratio-2 retina']/body/div[@class='container my-content']/form[@id='my-form']/div[@class='form-group'][4]/div[@class='col-sm-offset-2 col-sm-10']/div[@class='row']/div[@class='col-lg-12 col-md-12 col-sm-12 col-xs-12']/button[@class='btn btn-primary']").click()
time.sleep(4)
